    ...
    <div class="navbar-content h-[calc(100vh_-_74px)] py-2.5">
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-hasmenu">
          <a href="bc_color.php" class="pc-link">
            <span class="pc-micon"> <i data-feather="globe"></i></span>
            <span class="pc-mtext">All University</span>
          </a>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="bc_typography.php" class="pc-link">
            <span class="pc-micon"> <i data-feather="plus-square"></i></span>
            <span class="pc-mtext">Add University</span>
          </a>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="icon-feather.php" class="pc-link">
            <span class="pc-micon"> <i data-feather="toggle-right"></i></span>
            <span class="pc-mtext">University Status</span>
          </a>
        </li>
        <li class="pc-item pc-caption">
        ...
        <li class="pc-item pc-hasmenu">
          <a href="Colleges.php" class="pc-link">
            <span class="pc-micon"> <i data-feather="home"></i></span>
            <span class="pc-mtext">All College</span>
          </a>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="add_colleges.php" class="pc-link">
            <span class="pc-micon"> <i data-feather="plus-square"></i></span>
            <span class="pc-mtext">Add College</span>
          </a>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="college_status.php" class="pc-link">
            <span class="pc-micon"> <i data-feather="toggle-right"></i></span>
            <span class="pc-mtext">College Status</span>
          </a>
        </li>
        <li class="pc-item pc-caption">
          <label>Pages</label>
