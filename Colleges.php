...
<head>
    ...
    <style>
        /* ===== University/College Ledger theme — Light Mode Only ===== */
        .uni-page {
            --ink: #16233F;
            --ink-2: #2C3E63;
            --brass: #A9822E;
...
<body>
        ...
        <div class="pc-content uni-page">
            ...
            <div class="page-header uni-header">
                <div class="page-block">
                    <h1 class="uni-title">All Colleges</h1>
                    <ul class="uni-breadcrumb">
                        <li><a href="Index.php">Home</a></li>
                        <li><a href="javascript: void(0)">College Management</a></li>
                        <li style="color: var(--ink);">All Colleges</li>
                    </ul>
                </div>
            </div>
            <!-- [ breadcrumb ] end -->
            ...
            <div class="row g-3 mb-4 mt-1">
                <div class="col-md-4">
                    <div class="uni-stat uni-stat--active">
                        <div>
                            <div class="uni-stat-label">Active Colleges</div>
                ...
                <div class="col-md-4">
                    <div class="uni-stat uni-stat--inactive">
                        <div>
                            <div class="uni-stat-label">Inactive Colleges</div>
                ...
                <div class="col-md-4">
                    <div class="uni-stat uni-stat--total">
                        <div>
                            <div class="uni-stat-label">Total Colleges</div>
                ...
                <div class="col-12">
                    <div class="uni-card">
                        ...
                        <div class="uni-card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                            <div>
                                <h5 class="uni-card-title">College List</h5>
                                <div class="uni-card-sub">Search, review status, and manage every registered college.</div>
                            </div>
                            <div class="d-flex align-items-center gap-2">
                                <div class="uni-search">
                                    <i class="bi bi-search"></i>
                                    <input type="text" id="collegeSearch" class="form-control form-control-sm" placeholder="Search by name, email, slug...">
                                </div>
                                <a href="add_college.php" class="uni-btn-add">
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table uni-table align-middle mb-0" id="collegeTable">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Logo</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="assets/images/colleges/c1.png" class="uni-logo"></td>
                                            <td><span class="uni-name">Engineering College</span></td>
                                            <td><span class="uni-shortname">VNSGU</span></td>
                                            <td class="uni-email">engineering-college</td>
                                            <td class="uni-email">engg@college.com</td>
                                            <td class="uni-phone">+91 9876543210</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="assets/images/colleges/c2.png" class="uni-logo"></td>
                                            <td><span class="uni-name">Medical College</span></td>
                                            <td><span class="uni-shortname">GTU</span></td>
                                            <td class="uni-email">medical-college</td>
                                            <td class="uni-email">medical@college.com</td>
                                            <td class="uni-phone">+91 9123456780</td>
                                            <td><span class="uni-pill uni-pill--active status-badge"><span class="dot"></span>Active</span></td>
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input status-toggle" type="checkbox" checked>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="assets/images/colleges/c3.png" class="uni-logo"></td>
                                            <td><span class="uni-name">Business School</span></td>
                                            <td><span class="uni-shortname">VNSGU</span></td>
                                            <td class="uni-email">business-school</td>
                                            <td class="uni-email">biz@college.com</td>
                                            <td class="uni-phone">+91 9988776655</td>
                            ...
                            <div class="uni-pagination-wrap d-flex justify-content-between align-items-center px-3 py-3">
                                ...
                                <nav aria-label="College table pagination">
    ...
    <script>
        const allRows = Array.from(document.querySelectorAll('#collegeTable tbody tr'));
        let currentPage = 1;
        let rowsPerPage = 5;
        ...
        function renderPaginationInfo(totalRows, start, end) {
            ...
            if (totalRows === 0) {
                info.textContent = 'No colleges found';
                return;
            }
