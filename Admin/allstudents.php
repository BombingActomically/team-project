...
// ---------------------------------------------------------
// Peer Folder Upload Paths (Frontend Uploads)
// ---------------------------------------------------------
$IDCARD_DIR      = __DIR__ . '/../uploads/idcards';
$IDCARD_WEB_PATH = '../uploads/idcards/';

$PHOTO_DIR       = __DIR__ . '/../uploads';
$PHOTO_WEB_PATH  = '../uploads/';
...
<head>
    ...
    <title>All Students | Eventura Admin</title>
    ...
    <style>
        ...
        .student-name { font-weight: 600; color: #1f2937; white-space: normal; max-width: 250px; line-height: 1.4; word-wrap: break-word; display: block; }
        ...
        #studentTable { table-layout: auto; width: 100%; }
        #studentTable th, #studentTable td { white-space: nowrap; }
        #studentTable th:nth-child(2), #studentTable td:nth-child(2) { min-width: 200px; }
        #studentTable th:nth-child(3), #studentTable td:nth-child(3) { min-width: 220px; }
    ...
    <style>
        ...
        [data-pc-theme="dark"] .student-name,
        ...
        /* Misc elements */
        [data-pc-theme="dark"] .student-logo {
            border-color: var(--evenza-border) !important;
        ...
        <div class="pc-content">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="page-subtitle mb-3">Manage students registered on the Eventura platform</p>
                                    ...
                                    <?php foreach ($students as $i => $s): ?>
                                        <?php
                                            ...
                                            $defaultAvatar = $gender === 'female' 
                                                ? $femaleAvatars[(int) $s['student_id'] % count($femaleAvatars)] 
                                                : $maleAvatars[(int) $s['student_id'] % count($maleAvatars)];
                                                
                                            $fallbackSrc = 'assets/images/user/' . $defaultAvatar;
                                                
                                            $isCustomUpload = !empty($photoName) && !str_contains(strtolower($photoName), 'avatar') && !str_contains(strtolower($photoName), 'placeholder');
                                            
                                            $photoSrc = $isCustomUpload ? '../uploads/' . htmlspecialchars($photoName) : $fallbackSrc;
                                        ?>
                                        <tr>
                                            <td><?= $i + 1 ?></td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-3">
                                                    <img src="<?= $photoSrc ?>" class="student-logo flex-shrink-0" alt="Student Photo" onerror="this.onerror=null; this.src='<?= $fallbackSrc ?>';">
                                                    <div style="min-width: 0;">
                                                        <div class="student-name text-truncate" style="max-width: 200px;"><?= htmlspecialchars($s['name']) ?></div>
                                                        <?php if (!empty($s['enrollment_no'])): ?>
                                                            <small class="text-muted d-block text-truncate" style="font-size: 12px; line-height: 1.2; font-weight: 500; max-width: 200px;"><?= htmlspecialchars($s['enrollment_no']) ?></small>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </td>
