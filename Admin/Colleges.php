...
<head>
    ...
    <style>
        ...
        /* FIX: Prevents college name from overflowing its column */
        .college-name { font-weight: 600; color: #1f2937; white-space: normal; max-width: 280px; line-height: 1.4; word-wrap: break-word; display: block; }
        .college-logo { width: 46px; height: 46px; object-fit: cover; border-radius: 12px; border: 1px solid #e5e7eb; background: #f8f9fa; flex-shrink: 0; }
    ...
    <style>
        ...
        [data-pc-theme="dark"] .college-name,
        ...
        /* Misc elements */
        [data-pc-theme="dark"] .college-logo {
            border-color: var(--evenza-border) !important;
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
                ...
                <div>
                    ...
                    <p class="page-subtitle mb-3">
                        Manage colleges registered on the Evenza platform
                    </p>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-3">
                                                    <img src="<?= $logoSrc ?>" class="college-logo flex-shrink-0" alt="College Logo" onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name=<?= urlencode($c['name']) ?>&background=e8edff&color=4f46e5&rounded=true&bold=true';">
                                                    <div style="min-width: 0;">
                                                        <div class="college-name"><?= htmlspecialchars($c['name']) ?></div>
                                                        <small class="text-muted d-block text-truncate" style="font-size: 12px; line-height: 1.2; font-weight: 500; max-width: 250px;">
