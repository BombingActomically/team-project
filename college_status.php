...
<head>
    <title>College Status | Admin</title>
    <!-- [Meta] -->
    <meta charset="utf-8" />
...
<body>
    ...
    <div class="pc-container">
        <div class="pc-content">
            ...
            <!-- Page Header -->
            <h5 class="mb-0 font-medium">College Status</h5>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>2</td>
                        <td>XYZ Medical College</td>
                        <td>contact@xyz.edu</td>
                    ...
                    <tr>
                        <td>3</td>
                        <td>Global Business School</td>
                        <td>hello@global.edu</td>
                        <td><span class="badge bg-success">Active</span></td>
                        <td>
                            <div class="form-check form-switch">
                                <input class="form-check-input status-toggle" type="checkbox" checked>
