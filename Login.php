...
<head>
    ...
    <style>
        ...
        * {
        ...
        .inputForm svg[height="1em"] {
            cursor: pointer;
            fill: #8b8e98;
            margin-left: 8px;
        }

        .inputForm svg[height="1em"]:hover {
            fill: #2d79f3;
        }
...
<body>
    ...
    <form class="form" method="POST" action="Login.php">
        ...
        <div class="inputForm">
            ...
            <input type="password" name="password" class="input" placeholder="Enter your Password" id="passwordField" required>
            <svg viewBox="0 0 576 512" height="1em" xmlns="http://www.w3.org/2000/svg" id="togglePassword">
    ...
    <script>
        ...
        toggleIcon.addEventListener('click', function() {
            ...
            toggleIcon.style.opacity = isHidden ? '0.6' : '1';
        });
    </script>
