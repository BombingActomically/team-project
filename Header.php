...
<head>
  ...
  <script>
    (function() {
      try {
        // Consistently use 'theme' to read the saved preference
      ...
      <ul class="inline-flex *:min-h-header-height *:inline-flex *:items-center">
        <li class="dropdown pc-h-item">
          ...
          <div class="dropdown-menu dropdown-menu-end pc-h-dropdown">
            <a href="#!" class="dropdown-item" onclick="changeAdminTheme('dark')">
              <i data-feather="moon"></i>
              <span>Dark</span>
            </a>
            <a href="#!" class="dropdown-item" onclick="changeAdminTheme('light')">
              <i data-feather="sun"></i>
              <span>Light</span>
            </a>
            <a href="#!" class="dropdown-item" onclick="resetAdminTheme()">
          ...
          <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown p-2 overflow-hidden">
            <div class="dropdown-header flex items-center justify-between py-4 px-5 bg-primary-500">
              <div class="flex mb-1 items-center">
                ...
                <div class="grow ms-3">
                  <h6 class="mb-1 text-white"><?php echo isset($_SESSION['admin_email']) ? htmlspecialchars($_SESSION['admin_email']) : 'Admin'; ?> 🖖</h6>
                  <span class="text-white"><?php echo isset($_SESSION['admin_email']) ? htmlspecialchars($_SESSION['admin_email']) : ''; ?></span>
                </div>
              </div>
            </div>
...
<script>
/**
 * Theme is already applied as early as possible via the inline script
 * placed in <head> (before CSS loads) to avoid a flash of the wrong theme.
 *
 * These functions save the choice to 'theme' in localStorage, matching 
 * the lookup key used in the <head> block.
 */
...
function changeAdminTheme(theme) {
    ...
    // Saved with the matching key 'theme'
    localStorage.setItem("theme", theme);
}

function resetAdminTheme() {
    // Removed matching key 'theme'
